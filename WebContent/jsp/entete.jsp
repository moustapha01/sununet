          ...
          <tr>
            <td><b>APPEL Rejoignez nous et faites l'Histoire</b><br>	
              ...
              <table width="100%" height="20" border="0" cellpadding="0" cellspacing="0">
                <tr>
                  <td align="right"><a href="#" class="blye-text-underline">more</a>...</td>
                </tr>
              </table></td>
          </tr>
          <tr>
		...
		<table width="100%" border="0" cellspacing="0" cellpadding="0">
		  <tr>
			...
			<table width="700" border="0" cellspacing="5" cellpadding="5">
			  <tr>
				<td class="areaNav" width="140" align="center"><a class="nav" href="index.html">Acceuil</a></td>
				<td class="areaNav" width="140" align="center"><a class="nav" href="demandeur.html">Fiche Demandeur</a></td>
				<td class="areaNav" width="140" align="center"><a class="nav" href="volontaire.jsp">Fiche Volontaire</a></td>
				<td class="areaNav" width="140" align="center"><a class="nav" href="index.html">Services</a></td>
				<td class="areaNav" width="140" align="center"><a class="nav" href="faqs.html">FAQs</a></td>
				<td class="areaNav" width="140" align="center"><a class="nav" href="contact.html">Contacts</a></td>
			  </tr>
			</table>
