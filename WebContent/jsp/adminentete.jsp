				...
				<td>
					...
					<div id="volontaire_details" class="annonce">
						<table>			          
				          <tr>
				          	<td>
				          		<a class="blye-text-regular" href="allDemandeurs">nouveaux</a>
				          	</td>
				          </tr>			    
				          <tr>
				          	<td>
				          		<a class="blye-text-regular" href="allDemandeurs">existant</a>
				          	</td>
				          </tr>     
				          <tr>
				          	<td>
				          		<a class="blye-text-regular" href="allDemandeurs">expires</a>
				          	</td>
				          </tr>
			     	 	</table>	
			      	</div>					
